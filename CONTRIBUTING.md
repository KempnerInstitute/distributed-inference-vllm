...
> [!NOTE] 
> No actual environment files should be added to the repository. Instead, these files should be generated by contributors and shared externally (e.g., via Google Drive, AWS S3) with links provided in the README. Docker images can be built from the Dockerfiles and pushed to Docker Hub.
