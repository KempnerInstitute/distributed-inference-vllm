...
#### [u260304_vllm](uv/u260304_vllm/)
- **Python:** 3.12.11
- **CUDA:** 12.9.1
- **vLLM:** 0.11.2
- **PyTorch:** 2.9.0+cu129
- **Purpose:** Production-ready vLLM inference environment with CUDA 12.9 support
- **Features:**
  - Multi-GPU support with NCCL 2.27.5
  - Memory-efficient attention (xformers, flashinfer)
